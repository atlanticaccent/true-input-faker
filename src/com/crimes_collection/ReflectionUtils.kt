...
import com.crimes_collection.TrueInputFakerPlugin
import java.lang.invoke.MethodHandles
import java.lang.invoke.MethodType

object ReflectionUtils {
    private val fieldClass = Class.forName("java.lang.reflect.Field", false, TrueInputFakerPlugin.classLoader)
    ...
    private val methodClass = Class.forName("java.lang.reflect.Method", false, TrueInputFakerPlugin.classLoader)
    ...
    fun setStatic(clazz: Class<*>, fieldName: String, newValue: Any?) {
        var field: Any? = null
        ...
        setFieldAccessibleHandle.invoke(field, true)
        setFieldHandle.invoke(field, null, newValue)
    }
    ...
    fun getStatic(clazz: Class<*>, fieldName: String): Any? {
        var field: Any? = null
        ...
        setFieldAccessibleHandle.invoke(field, true)
        return getFieldHandle.invoke(field, null)
    }
